...
namespace WebAPIAutores.Controllers
{
    ...
    public class CuentasController:ControllerBase
    {
            ...
            )
        {
            ...
            dataProtectionProvider.CreateProtector("valor_unico_y_quizas_secreto");
        }
        ...
        public ActionResult RealizarHash(string textoPlano)
        {
            ...
            return Ok(new { textoPlano,resultado1, resultado2 });
        }
        ...
        public async Task<ActionResult<RespuestaAutenticacion>> Login(CredencialesUsuario credencialesUsuario)
        {
            var resultado= await signInManager.PasswordSignInAsync(
                credencialesUsuario.
                Email,credencialesUsuario.Password,isPersistent:false,lockoutOnFailure:false);
            if (resultado.Succeeded)
            {
                return await ConstruirToken(credencialesUsuario);
            }
        ...
        private async  Task< RespuestaAutenticacion> ConstruirToken(CredencialesUsuario credencialesUsuario)
        {
            ...
            claims.AddRange(claimsDB); // une los claims
